...
$sql1 = "DROP TABLE IF EXISTS `bpdc-arcd-db`.`student_course_list`;"
        . "CREATE TABLE `bpdc-arcd-db`.`student_course_list` "
        . "( `bits_id` VARCHAR(20) NOT NULL , `comp_code` INT NOT NULL ,"
...
$sql2 = "INSERT INTO `bpdc-arcd-db`.`student_course_list` (`bits_id`, `comp_code`, `section_code`) VALUES (?, ?, ?)";
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        ...
        try {
            ...
            $obj = new A($stmt, 'COURSE-STUDENT DETAILS', $target_file);
            $obj->operate();
            //end-----*
            $dbConn->commit();
